    ...
    <div className="auth-page-wrapper">
      <div className="auth-card" role="region" aria-labelledby="choose-register-title">
        ...
        <div style={{display:'flex', flexDirection:'column', gap:'16px'}}>
          ...
          <Link to="/event-partner/register" className="auth-submit" style={{textDecoration:'none', background:'var(--color-surface-alt)', color:'var(--color-text)', border:'1px solid var(--color-border)'}}>
            Register as event partner
          </Link>
        </div>
