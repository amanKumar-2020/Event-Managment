...
// Props:
// - items: Array of video items { _id, video, description, likeCount, savesCount, commentsCount, comments, eventPartner }
          ...
          <section key={item._id} className="reel" role="listitem">
            ...
            <div className="reel-overlay">
              ...
              <div className="reel-content">
                ...
                {item.eventPartner && (
                  <Link className="reel-btn" to={"/event-partner/" + item.eventPartner} aria-label="Visit store">Visit store</Link>
                )}
              </div>
            </div>
          </section>
